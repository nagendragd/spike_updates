...
#define FUNCT6_VFADD_VV (0b000000)
#define FUNCT6_VMUL_VV  (0b100101)
#define FUNCT6_VFMUL_VV (0b100100)
#define FUNCT6_VMUL_VX  (0b100101)
#define FUNCT6_VREDSUM_VS  (0b000000)
#define FUNCT6_VFREDSUM_VS (0b000001)
#define FUNCT6_VMV   (0b010111)
#define FUNCT6_VFMV  (0b010111)
...
#define VADD_VV(vd, vs1, vs2, vm) (OP_V | (vd << 7) | (OP_V_OPFVV << 12) | (vs1 << 15) | (vs2 << 20) | (vm << 25) | (FUNCT6_VADD_VV << 26))
#define VFADD_VV(vd, vs1, vs2, vm) (OP_V | (vd << 7) | (OP_V_OPFVV << 12) | (vs1 << 15) | (vs2 << 20) | (vm << 25) | (FUNCT6_VFADD_VV << 26))

#define VMUL_VV(vd, vs1, vs2, vm) (OP_V | (vd << 7) | (OP_V_OPMVV << 12) | (vs1 << 15) | (vs2 << 20) | (vm << 25) | (FUNCT6_VMUL_VV << 26))
#define VFMUL_VV(vd, vs1, vs2, vm) (OP_V | (vd << 7) | (OP_V_OPFVV << 12) | (vs1 << 15) | (vs2 << 20) | (vm << 25) | (FUNCT6_VFMUL_VV << 26))
...
#define VFMV_VX(vd, rs1) (OP_V | (vd << 7) | (OP_V_OPFVF << 12) | (rs1 << 15) | (0 << 20) | (1 << 25) | (FUNCT6_VFMV << 26))
...
#define VFREDSUM_VS(vd, vs1, vs2, vm) (OP_V | (vd << 7) | (OP_V_OPFVV << 12) | (vs1 << 15) | (vs2 << 20) | (vm << 25) | (FUNCT6_VFREDSUM_VS << 26))

#define VSETVLI(rd, rs1, imm) (OP_V | (rd << 7) | (0b111 << 12) | (rs1 << 15) | (imm << 20))

#define VLWV(vd, rs1) ( 0b0000111 | (vd << 7) | (EL_32 << 12) | (rs1 << 15) | (0b00000 << 20) | (0b1<<25) | (0b000<<26) | (0b000<<29) )
#define VLIWV(vd, rs1, vs2) ( 0b0000111 | (vd << 7) | (EL_32 << 12) | (rs1 << 15) | (vs2 << 20) | (0b1<<25) | (0b011<<26) | (0b000<<29) )
#define VLWV_F(vd, rs1) ( 0b0000111 | (vd << 7) | (FP_32 << 12) | (rs1 << 15) | (0b00000 << 20) | (0b1<<25) | (0b000<<26) | (0b000<<29) )

#define VSWV(rs, vs) ( 0b0100111 | (vs << 7) | (EL_32 << 12) | (rs << 15) | (0b00000 << 20) | (0b1<<25) | (0b000<<26) | (0b000<<29) )
#define VSWV_F(rs, vs) ( 0b0100111 | (vs << 7) | (FP_32 << 12) | (rs << 15) | (0b00000 << 20) | (0b1<<25) | (0b000<<26) | (0b000<<29) )
