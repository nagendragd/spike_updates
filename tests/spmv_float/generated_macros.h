...
#define add_r10_r10_imm_m_lower_12_macro asm volatile (".word 0x9c850513")
#define ld_r13_v_upper_20_macro asm volatile (".word 0x52d6b7")
#define add_r13_r13_imm_v_lower_12_macro asm volatile (".word 0xad068693")
#define ld_r28_y_upper_20_macro asm volatile (".word 0x52ee37")
#define add_r28_r28_imm_y_lower_12_macro asm volatile (".word 0xcd8e0e13")
...
#define vadd_vv_v11_v10_v13_vm_macro asm volatile (".word 0x2d515d7")
#define vmul_vv_v11_v10_v13_vm_macro asm volatile (".word 0x92d515d7")
...
#define vredsum_vs_v28_v28_v11_macro asm volatile (".word 0x6be1e57")
#define cp_r29_r13_macro asm volatile (".word 0x68e93")
#define cp_r13_r29_macro asm volatile (".word 0xe8693")
#define reset_v28_r0_macro asm volatile (".word 0x5e005e57")
#define ld_r12_imm_0xfffff_macro asm volatile (".word 0xfffff637")
#define ld_r23_n_upper_20_macro asm volatile (".word 0x2ebb7")
#define add_r23_r23_imm_n_lower_12_macro asm volatile (".word 0xf40b8b93")
...
#define add_r24_r24_imm_t_lower_12_macro asm volatile (".word 0xf98c0c13")
...
#define ld_r24_rows_upper_20_macro asm volatile (".word 0x530c37")
#define add_r24_r24_imm_rows_lower_12_macro asm volatile (".word 0x2e8c0c13")
#define sub_r24_r24_r12_macro asm volatile (".word 0x40cc0c33")
#define ld_r27_vals_upper_20_macro asm volatile (".word 0xa41db7")
#define add_r27_r27_imm_vals_lower_12_macro asm volatile (".word 0x4d8d8d93")
#define sub_r27_r27_r12_macro asm volatile (".word 0x40cd8db3")
#define ld_r28_cols_upper_20_macro asm volatile (".word 0x531e37")
#define add_r28_r28_imm_cols_lower_12_macro asm volatile (".word 0x4d0e0e13")
#define sub_r28_r28_r12_macro asm volatile (".word 0x40ce0e33")
#define ld_r29_v_upper_20_macro asm volatile (".word 0x52deb7")
#define add_r29_r29_imm_v_lower_12_macro asm volatile (".word 0xad0e8e93")
#define sub_r29_r29_r12_macro asm volatile (".word 0x40ce8eb3")
#define ld_r31_y_upper_20_macro asm volatile (".word 0x52efb7")
#define add_r31_r31_imm_y_lower_12_macro asm volatile (".word 0xcd8f8f93")
